...
def preprocess(checkpoint=None, direction='amr', split_both_decoder=False, fp16=False):
    ...
    gfiles = "/AIHCM/KGQA/NLPCore/content-writer/data/tmt/amr-v2-p5/*.amr.txt"
    
    import glob
    datafiles = glob.glob(gfiles)

    instantiate_loader(
        datafiles,
        tokenizer,
        batch_size=config['batch_size'],
        evaluation=True, out="/AIHCM/KGQA/NLPCore/content-writer/data/tmt",
    ...
    # train_gold_path = 'train-gold.amr'
